...
pub struct EncryptArgs {
    ...
    #[arg(long, help_heading = colors::ENCRYPTION_OPTIONS_HEADING)]
    pub overwrite: bool,
    ...
    #[arg(long = "passphrase-prompt", short = 'p', visible_alias = "pp", help_heading = colors::ENCRYPTION_OPTIONS_HEADING)]
